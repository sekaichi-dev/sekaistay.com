  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40 hidden w-[330px] sm:block">
        <div className="relative overflow-hidden rounded-2xl bg-[#F2691B] p-5 text-white shadow-[0_20px_50px_rgba(242,105,27,0.45)]">
          <button
            type="button"
      ...
      {/* モバイル: 下部の帯バー（常設CTA） */}
      <div className="fixed inset-x-0 bottom-0 z-40 bg-[#F2691B] px-4 pt-3 text-white pb-[calc(0.75rem+env(safe-area-inset-bottom))] sm:hidden">
        <div className="flex items-center gap-3">
          <div className="min-w-0 flex-1">
            <p className="truncate text-[13px] font-bold">無料収益診断</p>
            <p className="mt-0.5 truncate text-[11px] text-white/80">入力3分・無料</p>
          </div>
          <AuditLink
