...
import { RESULTS_PROOF } from '@/content/home/copy-questions'
      ...
      <div className="container-edit section-xl">
        ...
        <div className="heading-mb">
          <div className="chapter-marker">
            ...
            <span className="eyebrow">{RESULTS_PROOF.eyebrow}</span>
          </div>
          <h2 className="heading-hero text-ink mb-5 jp-keep max-w-4xl">
            <JP>{RESULTS_PROOF.headline}</JP>
          </h2>
        </div>
            ...
            {RESULTS_PROOF.summary.map((s, i) => (
              ...
              >
                <div className="flex items-baseline gap-1 mb-3">
                  ...
                  {s.unit && <span className="font-sans text-[18px] text-sekai-teal">{s.unit}</span>}
                </div>
        ...
        <p className="text-caption text-mid-gray mb-10 leading-relaxed jp-break">
          {RESULTS_PROOF.summarySource}
        </p>

        {/* Bridge — n=1 への自己言及 */}
        <p className="lead text-dark-gray jp-break max-w-3xl mb-12 md:mb-16">
          {RESULTS_PROOF.bridge}
        </p>
                    ...
                    {c.metrics.map((m, i) => (
                      <div key={i} className="min-w-0">
                        <div className="flex items-center justify-between gap-2 mb-2">
                          ...
                          <span className="font-sans text-[13px] text-sekai-teal">{m.delta}</span>
                        </div>
                        {m.from ? (
                          ...
                          <div className="font-sans font-light text-[24px] text-ink mb-3 jp-keep">{m.to}</div>
                        )}
        ...
        {/* Closing line */}
        <p className="mt-12 font-sans font-light text-[20px] md:text-[24px] text-ink leading-relaxed jp-break max-w-3xl">
          <JP>{RESULTS_PROOF.closing}</JP>
        </p>
        ...
        <div className="mt-9">
          ...
          <p className="text-caption text-mid-gray mt-3">{RESULTS_PROOF.ctaMicrocopy}</p>
        </div>
      </div>
    </section>
  )
