...
1. 🔴 **Meta Ads は停止中** — 再開判断要。広告運用引き継ぎ §4
2. 🔴 **LP A/Bテスト 3バリアント検証中** — 価格主導 (`/switch`) / ポータル主導 (`/switch/portal`) / Founder (`/switch/founder`) を Z≥1.96 の有意水準で1週間判定。LP/HP 引き継ぎ参照
