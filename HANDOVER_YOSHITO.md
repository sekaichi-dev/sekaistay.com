...
2. 🟢 **Google Ads が現状もっとも順調な広告媒体・CPL は今後さらに下がる試算**（広告）— 直近30日 全体 Spend ¥223K / CV 15件 / **平均 CPL ¥14,889**、Price 単独は **CPA ¥10,483**（Geo 単独は CPA ¥9,407）。5/29 以降は CV ゼロだった Trust(¥20K) + Portal(¥19K) + 旧 Core(¥13K) = **約 ¥52K の無駄予算がカット**されたので、CV を維持できれば **6月の CPL は ¥11,000 台に低下する試算**（¥223K − ¥52K = ¥171K ÷ CV 15 = **¥11,396**・約 23% 改善）。広告運用 §3
