...
7. 🟢 **ジローの X [@jiroisagame](https://x.com/jiroisagame) は既存約 4 万人フォロワー資産**（SNS）— ハンドル由来でゲーム実況系コンテンツのフォロワー基盤。SEKAI STAY 民泊コンテンツを投下するとリーチが跳ねるが、**既存フォロワー属性とのギャップ管理が必須**。SEKAI STAY 関連投稿は週1-2本に抑え、他コンテンツと共存させる方針。JIRO 番組告知では強力な拡散資産になる。**自動投稿はせず手動運用**（ジロー本人の判断で投稿）。SNS §3 + 広告運用 §5
