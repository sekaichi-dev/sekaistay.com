...
1. 🟢 **Vercel プロジェクトは `sekaistay-com` に統合済み**（2026-06-01・旧 `minpaku-audit` をリネーム）— LP/HP 引き継ぎ §2-1
2. 🔴 **Google Ads の競合社名負KW は 5/28 全削除済み**（共有リスト「SS共通-オフターゲット」19件のみ稼働）— 広告運用引き継ぎ §3-5
3. 🔴 **Meta Ads は現在 停止中** — 再開判断要・広告運用引き継ぎ §4
4. 🟡 **PR TIMES は 6/1 配信予定** — PR/メディア露出 §1
5. 🟡 **吉蔵 CRM がメイン・HubSpot 移行検討中** — リード獲得パイプライン §5
