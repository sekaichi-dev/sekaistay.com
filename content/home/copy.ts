...
export const FAQ = {
  ...
  items: [
    ...
    },
    {
      ...
      a: '新規立ち上げの初期費用は¥200,000〜です（他社からの乗り換えは¥100,000/物件）。物件タイプに応じたプロ写真撮影は立ち上げプランに含まれます。このほか新規開業時は別途、行政書士費用（許認可申請）、備品調達、初期清掃などの実費が発生します。物件条件・エリアに応じて事前に概算をお見積もりします。',
    },
    {
      category: 'new',
      q: '物件選びから相談できますか？',
