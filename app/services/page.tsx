...
const FAQ_ITEMS = [
  ...
  {
    q: '民泊をこれから始める場合は、何をしてもらえますか？',
    a: 'プロ写真撮影・OTA掲載の初期設定・料金初期設定・ハウスマニュアル作成・清掃会社の手配など、開業までの全8工程を立ち上げプランとして一括で代行します。許認可申請のサポートもご相談いただけます。詳しい内訳は料金ページをご覧ください。',
  },
  {
    q: '売上や運用状況はどこまで見えますか？',
...
const SUB_BIZ = [
  {
    ...
    desc: '物件選びや許認可の相談から、プロ写真撮影・OTA掲載の初期設定・料金設定・ハウスマニュアル作成・清掃会社の手配まで、開業までの全8工程を「立ち上げプラン」として一括代行。「何から手をつければ?」の段階から、運用が軌道に乗るまで専任チームが並走します。',
