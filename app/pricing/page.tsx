...
export const metadata: Metadata = {
  title: '料金',
  description:
    'SEKAI STAYの料金体系。毎月の基本料金は売上の8%＋月額10,000円/物件。初期費用は乗り換え¥100,000/物件・新規立ち上げプラン¥300,000（物件タイプに応じたプロ撮影込み）。かかりうる費用をすべて開示します。',
  openGraph: {
    title: '料金 | SEKAI STAY',
    description:
...
const EXTRAS = [
  { no: '01', title: '初期費用', body: '乗り換えは一律10万円、新規立ち上げは立ち上げプラン30万円（物件タイプに応じたプロ撮影込み・全8工程）。2026年8月31日までのお問い合わせで、どちらも初期費用から10万円割引になります。' },
...
const SETUP_STEPS = [
  { no: '01', title: 'プロ写真撮影', body: '物件タイプ（間取り・広さ）に応じたプロカメラマン撮影を標準で含みます。一戸建・ヴィラなど大きな物件は、事前見積もりのうえ差額をご案内します。撮影が不要な場合は、初期費用から¥80,000を割引します。' },
...
const PRICING_FAQ = [
  {
    ...
    a: '毎月の基本料金は、変動運営委託費（売上の8%）＋固定管理費10,000円/物件/月です。初期費用は乗り換えが100,000円/物件、新規立ち上げが立ち上げプラン300,000円/物件（物件タイプに応じたプロ撮影込み・全8工程）。このほかは消耗品などの実費（実費＋20%）と、ご希望のときだけの有料オプションのみで、かかりうる費用は契約前にすべて金額つきで提示します。※2026年8月31日までのお問い合わせは、初期費用10万円割引キャンペーンの対象です。',
  },
  {
  ...
  },
  {
    ...
    a: '立ち上げプラン300,000円/物件（一括）に、プロ写真撮影・OTAリスティング初期設定（Airbnb・Booking）・Airbnb登録用電話番号の代行取得・料金初期設定（ダイナミックプライシング）・キーボックス設定と設備確認・消耗品/アメニティ初期管理・ハウスマニュアル作成（多言語）・清掃会社の手配と公開の全8工程を含みます。撮影は物件タイプ（間取り・広さ）に応じた内容で、一戸建・ヴィラなど大きな物件は事前見積もりのうえ差額をご案内します。撮影が不要な場合は80,000円割引。2026年8月31日までのお問い合わせは、立ち上げ割引により200,000円になります。',
  },
  {
    q: '解約金はかかりますか？',
            ...
            <Reveal as="div" className="mt-12 sm:mt-16">
              ...
              <div className="mt-6 flex flex-wrap items-end gap-x-6 gap-y-3">
                ...
                <div className="mb-1 sm:mb-2">
                  ...
                  <p className="mt-1 text-[14px] font-bold text-white">物件タイプに応じたプロ写真撮影込み・初期費用から10万円割引</p>
                </div>
              </div>
            </Reveal>
            ...
            __html: JSON.stringify({
              ...
              offers: {
                ...
                offers: [
                  ...
                  { '@type': 'Offer', name: '初期費用（新規立ち上げ・立ち上げプラン）', price: '300000', priceCurrency: 'JPY', description: '1物件あたり300,000円（物件タイプに応じたプロ撮影込み）。OTA初期設定・ハウスマニュアル作成・清掃手配など立ち上げ全8工程を含む。', availability: 'https://schema.org/InStock' },
